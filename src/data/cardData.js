...
export const cardArray = [ 
  ...
  ['TT',  RFIC1,RRF1C3,   C,RRF1C3    ,R,RROPCA      ,R1C2,RR1C2,        EMPTY,  C],

  ['99',  RFIC1,F,       C,F    ,R,RRF1C3    ,R1C2,RR1C2,         EMPTY,  C],
  ['88',  RFIC1,F,      C1,F   ,R1C2,C3        ,C,RRLC3,            EMPTY,  C21ML],
  ['77',  C1,F,      C1,F   ,RFIC1,C3        ,C,RRLC3,            EMPTY,  C21ML],
  ['66',  C2,F,      F,F    ,C2,C4           ,C,C3,               EMPTY,  C21L_ALT],
  ['55',  C2,F,      F,F    ,C2,C4           ,C,C3,               EMPTY,  C21L_ALT],
  ['44',  C2,F,      F,F    ,C2,C4           ,C,C3,               EMPTY,  C2],
  ['33',  C2,F,      F,F    ,C2,C4            ,C,C3,               EMPTY,  C2],
  ['22',  C2,F,      F,F    ,C2,C4            ,C,C3,               EMPTY,  C2],

  ['AK',  R,RR,      R,RR   ,R,RR              ,R,RR,              EMPTY,  RRL],
  ['AQ',  R,RR,       R,C    ,R,RR          ,R12C3,RR12C3,      EMPTY,  CR12L],
  ['AJs', R,RR,       R,C    ,R,RROPCA          ,R1C2,RR1C2,        EMPTY,  C],
  ['AJ',  RFIC1,F,   C,F    ,R1C2,F            ,R1C2,RRLF,         EMPTY,  C],
  ['ATs', RFIC1,F,   C,F    ,R1C2,F            ,R1C2,RRLC1,        EMPTY,  C],
  ['AT',  RFIC1,F,   F,F    ,RFIC1,F           ,R1C2,RRLF,         EMPTY,  C],
  ['A9s', C,F,       C,F    ,RFIC1,F           ,R1C2,RRLF,            EMPTY,  C],
  ['A9',  F,F,       F,F    ,RFIOF,F           ,C,F,              EMPTY,  C1LF],
  ['A8s', C,F,       C1,F   ,RFIC1,F           ,C,C3,             EMPTY,  C1LF],
  ['A8',  F,F,       F,F    ,F,F               ,C,F,              EMPTY,  C1LF],
  ['A7s', C,F,       C1,F   ,RFIC1,F               ,C,C3,             EMPTY,  C],        
  ...
  ['KTs', C1,F,     F,F   ,R,F            ,C,F,      EMPTY,  C],
  ['KT',  F,F,      F,F   ,C2,F               ,C,F,      EMPTY,  C21L_ALT],
  ['K9s', F,F,      F,F   ,C2,F               ,C,F,      EMPTY,  C21L_ALT],
  ['K8s', F,F,      F,F   ,C3,F               ,C,F,      EMPTY,  C2],
